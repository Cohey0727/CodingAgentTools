...
target 'make setup-skills' 'link skills/, agents/ and AGENTS.md into every agent CLI'
target 'make list' 'every provider, skill and subagent, with its install status'
